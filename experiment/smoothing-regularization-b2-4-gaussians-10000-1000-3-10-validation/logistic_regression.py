...
class Logistic_Regression(object):
    ...
    def fit(self, xTrain, yTrain, verbos=False):
        ...
        print "xVallidation shape: ", xVallidation.shape
        ...
        try:
            ...
            while True:
                ...
                if iter % 100 == 0:
                    if self.validation_perc != 0:
                        valid_accuracy = self.accuracy(self.predict(xVallidation), yVallidation)
                        valid_loss = self.loss(xVallidation, yVallidation)
                        print "iter %4d\t|\tvalid_accuracy %10.6f\t|\tvalid_loss %10.10f"%(iter, valid_accuracy, valid_loss)
...
if __name__ == '__main__':
    ...
    reg_lambda, learning_rate, max_iter, eps, batch_size = 10, 0.0001, 3000000, 1e-10, 500
