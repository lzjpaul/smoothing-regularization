...
'''
do not update w
w_init is the optimal w
stop criteria delete (train-pre_train)
'''
import sys
...
class Logistic_Regression(object):
    ...
    def fit(self, xTrain, yTrain, w, gm_opt_method=-1, verbos=False):
        np.random.seed(10)
...
if __name__ == '__main__':
    ...
    LG.fit(xTrain, yTrain, w, gm_opt_method=-1, verbos=True)
