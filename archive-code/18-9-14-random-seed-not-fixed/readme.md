...
2018-9-14:
gm_prior_logistic_regression_a_b_all_fixed_gm: fix the pi and lambda to [0.75, 0.25][200, 10]

2018-9-14:
gm_prior_logistic_regression.py

10e-4 to 10e0 scale, 1,2,5,10 ...

2018-9-14:
seed not fixed (not change the data_loader.py because should be the same label!!)
logistic_regression.py
-- initialize weight
-- SGD mini-batch
gm_prior_logistic_regression_a_b_all.py: b delete 1e-4. 1e-2, 100 and 1000
