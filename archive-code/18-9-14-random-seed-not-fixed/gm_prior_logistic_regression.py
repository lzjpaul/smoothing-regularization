...
'''
'''
This uses the scientific a, b, alpha method
'''
...
if __name__ == '__main__':
    ...
    for i, (train_index, test_index) in enumerate(StratifiedKFold(y.reshape(y.shape[0]), n_folds=n_folds)):
        if i > 0:
            break
        fea_num = x.shape[1]
        b, alpha = [(fea_num * 0.0001), (fea_num * 0.0002), (fea_num * 0.0005),\
                    (fea_num * 0.001), (fea_num * 0.002), (fea_num * 0.005),\
                    (fea_num * 0.01), (fea_num * 0.02), (fea_num * 0.05),\
                    (fea_num * 0.1), (fea_num * 0.2), (fea_num * 0.5),\
                    (fea_num * 1), (fea_num * 2), (fea_num * 5), (fea_num * 10)],\
                   [fea_num**(0.5), fea_num**(0.3), fea_num**(0.7), fea_num**(0.9)]
