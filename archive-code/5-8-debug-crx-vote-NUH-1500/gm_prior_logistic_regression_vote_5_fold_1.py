...
if __name__ == '__main__':
    ...
    for i, (train_index, test_index) in enumerate(StratifiedKFold(y.reshape(y.shape[0]), n_folds=n_folds)):
        ...
        print "subsample i: ", i
        fea_num = x.shape[1]
        b, alpha = [(fea_num * 0.3), (0.5 * fea_num), (0.7 * fea_num), (fea_num), (3 * fea_num), (5 * fea_num), (7 * fea_num), (0.3 * fea_num * 1e-1), (0.5 * fea_num * 1e-1), (0.7 * fea_num * 1e-1), (fea_num * 1e-1), (3 * fea_num * 1e-1), (5 * fea_num * 1e-1), (7 * fea_num * 1e-1),\
                   (fea_num * 0.3 * 1e-2), (0.5 * fea_num * 1e-2), (0.7 * fea_num * 1e-2), (fea_num * 1e-2), (3 * fea_num * 1e-2), (5 * fea_num * 1e-2), (7 * fea_num * 1e-2), (0.3 * fea_num * 1e-3), (0.5 * fea_num * 1e-3), (0.7 * fea_num * 1e-3), (fea_num * 1e-3), (3 * fea_num * 1e-3), (5 * fea_num * 1e-3), (7 * fea_num * 1e-3)],\
                   [fea_num**(0.9), fea_num**(0.7)]
