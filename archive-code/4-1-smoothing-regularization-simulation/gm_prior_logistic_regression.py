...
if __name__ == '__main__':
    ...
    xTrain, xTest, yTrain, yTest = loadData(args.datapath, trainPerc=0.7)
    ...
    gm_opt_method, gm_num = args.gmoptmethod, args.gmnum
    pi, reg_lambda,  eps, batch_size \
        = [1.0/gm_num for _ in range(gm_num)], [_*10+1 for _ in  range(gm_num)], 1e-10, args.batchsize
    a, b, alpha = [1e-4, 0.1, 0.5, 1, 2, 5, 10], [1e-4, 0.1, 0.5, 1, 2, 5, 10, 100], [0, 10, 30 , 50, 100, 1000]
