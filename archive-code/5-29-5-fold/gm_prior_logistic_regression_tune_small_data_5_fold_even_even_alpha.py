...
if __name__ == '__main__':
    ...
    for i, (train_index, test_index) in enumerate(StratifiedKFold(y.reshape(y.shape[0]), n_folds=n_folds)):
        ...
        print "subsample i: ", i
        fea_num = x.shape[1]
        b, alpha = [(0.2 * fea_num), (0.4 * fea_num), (0.6 * fea_num), (0.8 * fea_num), (fea_num), (2 * fea_num), (4 * fea_num), (6 * fea_num), (8 * fea_num), (0.2 * fea_num * 1e-1), (0.4 * fea_num * 1e-1), (0.6 * fea_num * 1e-1), (0.8 * fea_num * 1e-1), (fea_num * 1e-1),\
                   (fea_num * 0.2 * 1e-2), (0.4 * fea_num * 1e-2), (0.6 * fea_num * 1e-2), (0.8 * fea_num * 1e-2), (fea_num * 1e-2), (0.2 * fea_num * 1e-3), (0.4 * fea_num * 1e-3), (0.6 * fea_num * 1e-3), (0.8 * fea_num * 1e-3), (fea_num * 1e-3)],\
                   [fea_num**(0.8), fea_num**(0.6), fea_num**(0.4), fea_num**(0.2)]
