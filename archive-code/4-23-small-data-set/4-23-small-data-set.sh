...
python elasticnet_logistic_regression_3.py -datapath data/NUH-DIAG.pkl -onehot 0 -sparsify 0 -batchsize 100 -wlr 4 -maxiter 140000 | tee -a /data/zhaojing/regularization/log0423/small-data-set/small-data-set-25
python elasticnet_logistic_regression_4.py -datapath data/NUH-DIAG.pkl -onehot 0 -sparsify 0 -batchsize 100 -wlr 4 -maxiter 140000 | tee -a /data/zhaojing/regularization/log0423/small-data-set/small-data-set-26
...
python elasticnet_logistic_regression_3.py -datapath data/NUH-DIAG-DEMOR.pkl -onehot 0 -sparsify 0 -batchsize 100 -wlr 4 -maxiter 140000 | tee -a /data/zhaojing/regularization/log0423/small-data-set/small-data-set-43
python elasticnet_logistic_regression_4.py -datapath data/NUH-DIAG-DEMOR.pkl -onehot 0 -sparsify 0 -batchsize 100 -wlr 4 -maxiter 140000 | tee -a /data/zhaojing/regularization/log0423/small-data-set/small-data-set-44
...
python elasticnet_logistic_regression_3.py -datapath data/NUH-LAB-DIAG-DEMOR.pkl -onehot 0 -sparsify 0 -batchsize 100 -wlr 4 -maxiter 140000 | tee -a /data/zhaojing/regularization/log0423/small-data-set/small-data-set-61
python elasticnet_logistic_regression_4.py -datapath data/NUH-LAB-DIAG-DEMOR.pkl -onehot 0 -sparsify 0 -batchsize 100 -wlr 4 -maxiter 140000 | tee -a /data/zhaojing/regularization/log0423/small-data-set/small-data-set-62
...
python elasticnet_logistic_regression_3.py -datapath data/diabetic_data_diag_low_dim_2_class_categorical.pkl -onehot 1 -sparsify 0 -batchsize 500 -wlr 6 -maxiter 500000 | tee -a /data/zhaojing/regularization/log0423/small-data-set/small-data-set-79
python elasticnet_logistic_regression_4.py -datapath data/diabetic_data_diag_low_dim_2_class_categorical.pkl -onehot 1 -sparsify 0 -batchsize 500 -wlr 6 -maxiter 500000 | tee -a /data/zhaojing/regularization/log0423/small-data-set/small-data-set-80
