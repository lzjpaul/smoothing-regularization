...
if __name__ == '__main__':
    gm_num, dimension, sample_num = 2, 1000, 50000
    pi, variance, covariance = np.array([0.75, 0.25]), np.array([0.005, 0.1]), np.identity(dimension)#generateCov(n=dimension, a=1, showCov=False)
